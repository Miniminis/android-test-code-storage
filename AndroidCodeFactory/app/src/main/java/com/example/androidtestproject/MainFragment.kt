...
//                (this.activity as MainActivity).bottom_navigation.visibility = View.GONE
            ...
            R.id.menu_image_compression -> {
                this.findNavController().navigate(R.id.action_mainFragment_to_imageCompression)
                (this.activity as MainActivity).bottom_navigation.visibility = View.GONE
                return@OnNavigationItemSelectedListener true
            }
            R.id.menu_news_application -> {
                this.findNavController().navigate(R.id.action_mainFragment_to_newsMainActivity)
                (this.activity as MainActivity).bottom_navigation.visibility = View.GONE
                return@OnNavigationItemSelectedListener true
            }
            R.id.menu_network -> {
                this.findNavController().navigate(R.id.action_mainFragment_to_networkMainActivity)
                (this.activity as MainActivity).bottom_navigation.visibility = View.GONE
                return@OnNavigationItemSelectedListener true
            }
            R.id.menu_animation -> {
                this.findNavController().navigate(R.id.action_mainFragment_to_animation)
                (this.activity as MainActivity).bottom_navigation.visibility = View.GONE
                return@OnNavigationItemSelectedListener true
            }
            else -> { false }
