...
import com.example.androidtestproject.databinding.FragmentTriviaGameBinding
...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val binding = DataBindingUtil.inflate<FragmentTriviaGameBinding>(
                inflater, R.layout.fragment_trivia_game, container, false)
...
//                        this.findNavController().navigate(R.id.action_gameFragment_to_gameWonFragment)
                        this.findNavController().navigate(GameFragmentDirections.actionGameFragmentToGameWonFragment(numQuestions, questionIndex))
                    }
                } else {
